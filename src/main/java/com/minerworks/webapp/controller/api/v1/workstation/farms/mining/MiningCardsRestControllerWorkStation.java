package com.minerworks.webapp.controller.api.v1.workstation.farms.mining;
...
@RestController
@RequestMapping("/api/v1/workstation/farms/mining/cards")
public class MiningCardsRestControllerWorkStation {

    private Logger logger = LoggerFactory.getLogger(MiningCardsRestControllerWorkStation.class);
    ...
    public ResponseEntity<MiningCardEntity> update(Principal principal, @PathVariable("farmUUID") String farmUUID, @RequestBody MiningCardEntity miningCardEntity) {
        ...
        if (!miningCardEntityService.isMiningCardExist(user, farmUUID, miningCardEntity)) {
            logger.debug("Mining Card for user {} and farm (farm code) {} \n" +
                            "with CoinOne {} PoolCoinOne {} \n" +
                            "and CoinTwo {} PoolCoinTwo {} \n" +
                            "not found.",
                    user, farmUUID,
